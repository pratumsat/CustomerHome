...
class SelectDistrictViewController: UIViewController {
    ...
    func bind()  {
        ...
        let viewModel = SelectDistrictViewModel.instance()
        ...
        let input = SelectDistrictViewModel.Input( onLoadView: onload,
                                                  onItem: onItem )
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.destination is SelectSubdistrictViewController {
            let des = segue.destination as! SelectSubdistrictViewController
    ...
    func onSubDistric(){
        self.performSegue(withIdentifier: "tosubdistric", sender: self)
    }
}
