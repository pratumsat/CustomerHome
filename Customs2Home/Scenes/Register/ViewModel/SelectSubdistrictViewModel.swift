//
//  SelectSubdistrictViewModel.swift
//  Customs2Home
//
...
class SelectSubdistrictViewModel: BaseViewModel<SelectSubdistrictViewModel>,ViewModelProtocol {

    typealias M = SelectSubdistrictViewModel
    typealias T = SelectSubdistrictViewController
    static var obj_instance: SelectSubdistrictViewModel?
...
//    }
    ...
    func transform(input: Input) -> Output {
        ...
        return SelectSubdistrictViewModel.Output(items: item,
...
extension SelectSubdistrictViewModel {
    struct Input {
