//
//  DeclareSelectProvinceViewController.swift
//  Customs2Home
//
...
class DeclareSelectProvinceViewController: UIViewController {
    ...
    func bind()  {
        ...
        let viewModel = DeclareSelectProvinceViewModel.instance()
        ...
        let input = DeclareSelectProvinceViewModel.Input( onLoadView: onload,
                                                   onItem: onItem )
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.destination is DeclareSelectDistrictViewController {
            let des = segue.destination as! DeclareSelectDistrictViewController
    ...
    func onArea(){
        self.performSegue(withIdentifier: "detodistrict", sender: self)
    }
}
